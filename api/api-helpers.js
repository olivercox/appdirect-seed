...
function getEventDescription(eventData) {
  console.log(eventData.event.payload);
...
module.exports.checkForEventUrl = checkForEventUrl;
module.exports.getAddOnEventDescription = getAddOnEventDescription;
module.exports.getUserEventDescription = getUserEventDescription
